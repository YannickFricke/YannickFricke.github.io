...
export const ResettableStateInReact: React.FC = () => {
    return <div>
        ...
        <p>Yesterday someone on a Discord server I'm also in posted a link to this repository: <a
        ...
        <p>I have been using React now for about 1 - 1,5 years and I never thought about resetting the state to its initial state.</p>
        <p>Quickly (in 7 minutes) I smashed together a custom react hook which exactly does this one thing... and I published it on NPM too!</p>
        ...
        <p>And also being an open source enthusiast I published the source code as well under the MIT license: <a
        ...
        <p>The readme file also includes a code example for JavaScript. If you are using TypeScript take a look at the examples (since they are written in TypeScript).</p>
        <p>So far,</p>
        <p>Yannick Fricke</p>
