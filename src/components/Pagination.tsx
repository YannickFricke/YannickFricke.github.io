...
export const Pagination: React.FC<IPaginationProps<unknown>> = (props) => {
           ...
           const [pages, setPages] = useState(Math.ceil(props.array.length / elementsPerPage));
           ...
           useEffect(() => {
               ...
               setElements(
                   props.array.slice(position, position + elementsPerPage),
               );
           }, [page, props.array]);

           console.log({ elements, page, calc: (page - 1) * elementsPerPage });
           ...
           return <div className="pagination">
               <div className="pagination--controls">
                   ...
                   <div className="pages">
                       {Array(pages).fill(0).map((_, index) => <div className="page" onClick={() => setPage(index + 1)}>
                           &bull;
                       </div>)}
                   </div>
